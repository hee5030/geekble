...
#define PI 3.141592
#define WHEEL_DIAMETER 0.130
#define WHEEL_WITH 0.4
...
namespace aidl
{
	...
	public:
											   ...
											   cur_x_(0), cur_y_(0), cur_th_(0), cur_vx_(0), cur_vy_(0), cur_vth_(0)
		{
			...
			odometry_publisher_ = nh_private_->advertise<nav_msgs::Odometry>("noisy_odom", 50);
		...
		void odom_compute(const ros::TimerEvent &e)
		{
			...
			delta_th_ = (0.97)*cur_vth_ * delta_t_;
