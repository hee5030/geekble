...
#include <ip050_motor_driver/can_handler.h>
...
const boost::array<uint8_t, 8UL> SET_VELOCITY_MODE_FRAME = {0x2F, 0x60, 0x60, 0x00, 0x03, 0x00, 0x00, 0x00};
...
public:
	...
	void cmd_rpm_callback(const ip050_msgs::RobotMotor::ConstPtr &msg);
