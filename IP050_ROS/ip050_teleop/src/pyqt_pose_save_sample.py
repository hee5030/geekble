...
class PoseSaver:
    ...
    def save_current_pose(self, where: str):
        ...
        # filename = os.path.join('/home/aidl/catkin_ws/src/IP200_ROS/ip200_teleop/config/', 'params' + '_' + str(self.current_file_location) + '.yaml')
        filename = os.path.join('/home/jusang/geekble_ws/src/IP050_ROS/ip050_teleop/config/', 'params' + '_' + str(self.current_file_location) + '.yaml')
...
class MainWindow(QMainWindow):
    def __init__(self, pose_saver):
        ...
        self.button5 = QPushButton('Docking 좌표에 저장')
        self.button5.clicked.connect(lambda: self.pose_saver.save_current_pose('docking'))
